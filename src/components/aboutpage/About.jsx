  ...
  return (
      ...
      className="bg-cover bg-center min-h-screen relative flex justify-center items-center">
          ...
          <div className="relative p-10 my-5 max-w-4xl backdrop-blur-sm bg-black/30 rounded-xl">
              <h1 className='md:text-6xl sm:text-5xl max-sm:text-4xl font-extrabold text-center underline bg-linear-to-r from-red-500 to-yellow-500 bg-clip-text text-transparent inline-flex '>About Us</h1>
          ...
          <h1 className='md:text-6xl sm:text-5xl max-sm:text-4xl font-extrabold text-center bg-linear-to-r from-red-500 to-yellow-500 bg-clip-text text-transparent inline-flex mt-10 underline'>Our Mission</h1>
          ...
          <h1 className='md:text-6xl sm:text-5xl max-sm:text-4xl font-extrabold text-center  bg-linear-to-r from-red-500 to-yellow-500 bg-clip-text text-transparent inline-flex mt-10 underline'>What We Offer</h1>
          <p className="text-white">We provide a range of professional real estate photo enhancement services, including:</p>
          <ul className="text-white mt-5 list-disc pl-6">
          ...
          <h1 className='md:text-6xl sm:text-5xl max-sm:text-4xl font-extrabold text-center  bg-linear-to-r from-red-500 to-yellow-500 bg-clip-text text-transparent inline-flex mt-10 underline'>Why Choose Us</h1>
          <p className="text-white" style={{fontFamily:"system-ui"}}>We focus on providing a simple and efficient workflow for photographers and real estate professionals. Our platform allows you to easily upload images, provide editing instructions, and receive professionally edited photos with a fast turnaround time.</p>

          <p className="text-white mt-5" style={{fontFamily:"system-ui"}}>Our commitment is to deliver consistent quality, reliable service, and edits that enhance your  <br />unique photography style.</p>
